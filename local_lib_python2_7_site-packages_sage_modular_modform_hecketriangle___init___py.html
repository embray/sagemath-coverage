...
<head>
    ...
    <title>Coverage for local/lib/python2.7/site-packages/sage/modular/modform_hecketriangle/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>local/lib/python2.7/site-packages/sage/modular/modform_hecketriangle/__init__.py</b> :
...
<p id="t2" class="stm run hide_run"><span class="key">from</span> <span class="op">.</span> <span class="key">import</span> <span class="nam">all</span><span class="strut">&nbsp;</span></p>
