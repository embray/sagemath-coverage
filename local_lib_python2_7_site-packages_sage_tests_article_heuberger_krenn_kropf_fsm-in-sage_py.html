...
<head>
    ...
    <title>Coverage for local/lib/python2.7/site-packages/sage/tests/article_heuberger_krenn_kropf_fsm-in-sage.py: 0%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>local/lib/python2.7/site-packages/sage/tests/article_heuberger_krenn_kropf_fsm-in-sage.py</b> :
...
<p id="t2" class="pln"><span class="str">This file contains doctests of the article</span><span class="strut">&nbsp;</span></p>
<p id="t3" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t4" class="pln"><span class="str">    Automata and Transducers</span><span class="strut">&nbsp;</span></p>
<p id="t5" class="pln"><span class="str">    in the Computer Algebra System Sage</span><span class="strut">&nbsp;</span></p>
<p id="t6" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t7" class="pln"><span class="str">by Clemens Heuberger, Daniel Krenn, and Sara Kropf, :arxiv:`1404.7458`.</span><span class="strut">&nbsp;</span></p>
<p id="t8" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t9" class="pln"><span class="str">IF IT BECOMES NECESSARY TO CHANGE ANY TESTS IN THIS FILE, THERE</span><span class="strut">&nbsp;</span></p>
<p id="t10" class="pln"><span class="str">NEEDS TO BE A ONE-YEAR DEPRECATION PERIOD. ALSO, PLEASE INFORM</span><span class="strut">&nbsp;</span></p>
<p id="t11" class="pln"><span class="str">    Clemens Heuberger &lt;clemens.heuberger@aau.at>,</span><span class="strut">&nbsp;</span></p>
<p id="t12" class="pln"><span class="str">    Daniel Krenn &lt;devel@danielkrenn.at>, AND</span><span class="strut">&nbsp;</span></p>
<p id="t13" class="pln"><span class="str">    Sara Kropf &lt;sara.kropf@aau.at></span><span class="strut">&nbsp;</span></p>
<p id="t14" class="pln"><span class="str">IN THIS CASE REGARDING THE CHANGES!</span><span class="strut">&nbsp;</span></p>
<p id="t15" class="pln"><span class="str">"""</span><span class="strut">&nbsp;</span></p>
<p id="t16" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t17" class="stm mis"><span class="str">"""</span><span class="strut">&nbsp;</span></p>
<p id="t18" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t19" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 376::</span><span class="strut">&nbsp;</span></p>
<p id="t20" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t21" class="pln"><span class="str">    sage: NAF_Abb = Transducer([(-1, 0, 0, None), (-1, 1, 1, None), (0, 0, 0, 0),</span><span class="strut">&nbsp;</span></p>
<p id="t22" class="pln"><span class="str">    ....:                       (0, 1, 1, 0), (1, 0, 0, 1), (1, 2, 1, -1),</span><span class="strut">&nbsp;</span></p>
<p id="t23" class="pln"><span class="str">    ....:                       (2, 1, 0, 0), (2, 2, 1, 0)],</span><span class="strut">&nbsp;</span></p>
<p id="t24" class="pln"><span class="str">    ....:                       initial_states=[-1], final_states=[0],</span><span class="strut">&nbsp;</span></p>
<p id="t25" class="pln"><span class="str">    ....:                       input_alphabet=[0, 1])</span><span class="strut">&nbsp;</span></p>
<p id="t26" class="pln"><span class="str">    sage: NAF_Abb.state(-1).format_label=lambda: r'\mathcal{I}'</span><span class="strut">&nbsp;</span></p>
<p id="t27" class="pln"><span class="str">    sage: NAF_Abb.latex_options(</span><span class="strut">&nbsp;</span></p>
<p id="t28" class="pln"><span class="str">    ....:     coordinates = {-1: (1.5, 3),</span><span class="strut">&nbsp;</span></p>
<p id="t29" class="pln"><span class="str">    ....:                    0: (0, 0),</span><span class="strut">&nbsp;</span></p>
<p id="t30" class="pln"><span class="str">    ....:                    1: (3, 0),</span><span class="strut">&nbsp;</span></p>
<p id="t31" class="pln"><span class="str">    ....:                    2: (6, 0)},</span><span class="strut">&nbsp;</span></p>
<p id="t32" class="pln"><span class="str">    ....:     initial_where = {-1: 'above'},</span><span class="strut">&nbsp;</span></p>
<p id="t33" class="pln"><span class="str">    ....:     format_letter=NAF_Abb.format_letter_negative,</span><span class="strut">&nbsp;</span></p>
<p id="t34" class="pln"><span class="str">    ....:     loop_where = lambda x: 'below')</span><span class="strut">&nbsp;</span></p>
<p id="t35" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t36" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t37" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 377::</span><span class="strut">&nbsp;</span></p>
<p id="t38" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t39" class="pln"><span class="str">    sage: str(latex(NAF_Abb))</span><span class="strut">&nbsp;</span></p>
<p id="t40" class="pln"><span class="str">    '\\begin{tikzpicture}[auto, initial text=, >=latex]\n\\node[state, initial, initial where=above] (v0) at (1.500000, 3.000000) {$\\mathcal{I}$};\n\\node[state, accepting] (v1) at (0.000000, 0.000000) {$0$};\n\\node[state] (v2) at (3.000000, 0.000000) {$1$};\n\\node[state] (v3) at (6.000000, 0.000000) {$2$};\n\\path[->] (v0) edge node[rotate=63.43, anchor=south] {$0\\mid \\varepsilon$} (v1);\n\\path[->] (v0) edge node[rotate=-63.43, anchor=south] {$1\\mid \\varepsilon$} (v2);\n\\path[->] (v1) edge[loop below] node {$0\\mid 0$} ();\n\\path[->] (v1.5.00) edge node[rotate=0.00, anchor=south] {$1\\mid 0$} (v2.175.00);\n\\path[->] (v2.185.00) edge node[rotate=360.00, anchor=north] {$0\\mid 1$} (v1.355.00);\n\\path[->] (v2.5.00) edge node[rotate=0.00, anchor=south] {$1\\mid \\overline{1}$} (v3.175.00);\n\\path[->] (v3.185.00) edge node[rotate=360.00, anchor=north] {$0\\mid 0$} (v2.355.00);\n\\path[->] (v3) edge[loop below] node {$1\\mid 0$} ();\n\\end{tikzpicture}'</span><span class="strut">&nbsp;</span></p>
<p id="t41" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t42" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t43" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 395::</span><span class="strut">&nbsp;</span></p>
<p id="t44" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t45" class="pln"><span class="str">    sage: NAF1 = Transducer([('I', 0, 0, None), ('I', 1, 1, None),</span><span class="strut">&nbsp;</span></p>
<p id="t46" class="pln"><span class="str">    ....:                    (0, 0, 0, 0), (0, 1, 1, 0),</span><span class="strut">&nbsp;</span></p>
<p id="t47" class="pln"><span class="str">    ....:                    (1, 0, 0, 1), (1, 2, 1, -1),</span><span class="strut">&nbsp;</span></p>
<p id="t48" class="pln"><span class="str">    ....:                    (2, 1, 0, 0), (2, 2, 1, 0)],</span><span class="strut">&nbsp;</span></p>
<p id="t49" class="pln"><span class="str">    ....:                   initial_states=['I'], final_states=[0],</span><span class="strut">&nbsp;</span></p>
<p id="t50" class="pln"><span class="str">    ....:                   input_alphabet=[0, 1])</span><span class="strut">&nbsp;</span></p>
<p id="t51" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t52" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t53" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 422::</span><span class="strut">&nbsp;</span></p>
<p id="t54" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t55" class="pln"><span class="str">    sage: NAF = NAF1</span><span class="strut">&nbsp;</span></p>
<p id="t56" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t57" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t58" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 434::</span><span class="strut">&nbsp;</span></p>
<p id="t59" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t60" class="pln"><span class="str">    sage: sage.combinat.finite_state_machine.FSMOldProcessOutput = False</span><span class="strut">&nbsp;</span></p>
<p id="t61" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t62" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t63" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 455::</span><span class="strut">&nbsp;</span></p>
<p id="t64" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t65" class="pln"><span class="str">    sage: str(12.digits(base=2))</span><span class="strut">&nbsp;</span></p>
<p id="t66" class="pln"><span class="str">    '[0, 0, 1, 1]'</span><span class="strut">&nbsp;</span></p>
<p id="t67" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t68" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t69" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 460::</span><span class="strut">&nbsp;</span></p>
<p id="t70" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t71" class="pln"><span class="str">    sage: NAF.process(12.digits(base=2)),</span><span class="strut">&nbsp;</span></p>
<p id="t72" class="pln"><span class="str">    ((False, 2, [0, 0, -1]),)</span><span class="strut">&nbsp;</span></p>
<p id="t73" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t74" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t75" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 461::</span><span class="strut">&nbsp;</span></p>
<p id="t76" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t77" class="pln"><span class="str">    sage: str(NAF.process(12.digits(base=2)))</span><span class="strut">&nbsp;</span></p>
<p id="t78" class="pln"><span class="str">    '(False, 2, [0, 0, -1])'</span><span class="strut">&nbsp;</span></p>
<p id="t79" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t80" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t81" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 471::</span><span class="strut">&nbsp;</span></p>
<p id="t82" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t83" class="pln"><span class="str">    sage: NAF_of_12 = NAF(12.digits(base=2) + [0, 0, 0])</span><span class="strut">&nbsp;</span></p>
<p id="t84" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t85" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t86" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 472::</span><span class="strut">&nbsp;</span></p>
<p id="t87" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t88" class="pln"><span class="str">    sage: str(NAF_of_12)</span><span class="strut">&nbsp;</span></p>
<p id="t89" class="pln"><span class="str">    '[0, 0, -1, 0, 1, 0]'</span><span class="strut">&nbsp;</span></p>
<p id="t90" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t91" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t92" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 482::</span><span class="strut">&nbsp;</span></p>
<p id="t93" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t94" class="pln"><span class="str">    sage: NAF = NAF.with_final_word_out(0)</span><span class="strut">&nbsp;</span></p>
<p id="t95" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t96" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t97" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 494::</span><span class="strut">&nbsp;</span></p>
<p id="t98" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t99" class="pln"><span class="str">    sage: NAF_of_12 = NAF(12.digits(base=2))</span><span class="strut">&nbsp;</span></p>
<p id="t100" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t101" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t102" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 496::</span><span class="strut">&nbsp;</span></p>
<p id="t103" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t104" class="pln"><span class="str">    sage: str(NAF_of_12)</span><span class="strut">&nbsp;</span></p>
<p id="t105" class="pln"><span class="str">    '[0, 0, -1, 0, 1]'</span><span class="strut">&nbsp;</span></p>
<p id="t106" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t107" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t108" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 534::</span><span class="strut">&nbsp;</span></p>
<p id="t109" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t110" class="pln"><span class="str">    sage: def NAF_transition(state_from, read):</span><span class="strut">&nbsp;</span></p>
<p id="t111" class="pln"><span class="str">    ....:     if state_from == 'I':</span><span class="strut">&nbsp;</span></p>
<p id="t112" class="pln"><span class="str">    ....:         write = None</span><span class="strut">&nbsp;</span></p>
<p id="t113" class="pln"><span class="str">    ....:         state_to = read</span><span class="strut">&nbsp;</span></p>
<p id="t114" class="pln"><span class="str">    ....:         return (state_to, write)</span><span class="strut">&nbsp;</span></p>
<p id="t115" class="pln"><span class="str">    ....:     current = 2*read + state_from</span><span class="strut">&nbsp;</span></p>
<p id="t116" class="pln"><span class="str">    ....:     if current % 2 == 0:</span><span class="strut">&nbsp;</span></p>
<p id="t117" class="pln"><span class="str">    ....:         write = 0</span><span class="strut">&nbsp;</span></p>
<p id="t118" class="pln"><span class="str">    ....:     elif current % 4 == 1:</span><span class="strut">&nbsp;</span></p>
<p id="t119" class="pln"><span class="str">    ....:         write = 1</span><span class="strut">&nbsp;</span></p>
<p id="t120" class="pln"><span class="str">    ....:     else:</span><span class="strut">&nbsp;</span></p>
<p id="t121" class="pln"><span class="str">    ....:         write = -1</span><span class="strut">&nbsp;</span></p>
<p id="t122" class="pln"><span class="str">    ....:     state_to = (current - write) / 2</span><span class="strut">&nbsp;</span></p>
<p id="t123" class="pln"><span class="str">    ....:     return (state_to, write)</span><span class="strut">&nbsp;</span></p>
<p id="t124" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t125" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t126" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 544::</span><span class="strut">&nbsp;</span></p>
<p id="t127" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t128" class="pln"><span class="str">    sage: NAF2 = Transducer(NAF_transition,</span><span class="strut">&nbsp;</span></p>
<p id="t129" class="pln"><span class="str">    ....:                   initial_states=['I'],</span><span class="strut">&nbsp;</span></p>
<p id="t130" class="pln"><span class="str">    ....:                   final_states=[0],</span><span class="strut">&nbsp;</span></p>
<p id="t131" class="pln"><span class="str">    ....:                   input_alphabet=[0, 1]).with_final_word_out(0)</span><span class="strut">&nbsp;</span></p>
<p id="t132" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t133" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t134" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 548::</span><span class="strut">&nbsp;</span></p>
<p id="t135" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t136" class="pln"><span class="str">    sage: NAF == NAF2</span><span class="strut">&nbsp;</span></p>
...
<p id="t140" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 549::</span><span class="strut">&nbsp;</span></p>
<p id="t141" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t142" class="pln"><span class="str">    sage: str(NAF==NAF2)</span><span class="strut">&nbsp;</span></p>
...
<p id="t146" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 579::</span><span class="strut">&nbsp;</span></p>
<p id="t147" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t148" class="pln"><span class="str">    sage: def f(state_from, read):</span><span class="strut">&nbsp;</span></p>
<p id="t149" class="pln"><span class="str">    ....:     current = 3*read + state_from</span><span class="strut">&nbsp;</span></p>
<p id="t150" class="pln"><span class="str">    ....:     write = current % 2</span><span class="strut">&nbsp;</span></p>
<p id="t151" class="pln"><span class="str">    ....:     state_to = (current - write) / 2</span><span class="strut">&nbsp;</span></p>
<p id="t152" class="pln"><span class="str">    ....:     return (state_to, write)</span><span class="strut">&nbsp;</span></p>
<p id="t153" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t154" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t155" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 588::</span><span class="strut">&nbsp;</span></p>
<p id="t156" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t157" class="pln"><span class="str">    sage: Triple = Transducer(f, input_alphabet=[0, 1],</span><span class="strut">&nbsp;</span></p>
<p id="t158" class="pln"><span class="str">    ....:                     initial_states=[0],</span><span class="strut">&nbsp;</span></p>
<p id="t159" class="pln"><span class="str">    ....:                     final_states=[0]).with_final_word_out(0)</span><span class="strut">&nbsp;</span></p>
<p id="t160" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t161" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t162" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 592::</span><span class="strut">&nbsp;</span></p>
<p id="t163" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t164" class="pln"><span class="str">    sage: three_times_four = Triple(4.digits(base=2))</span><span class="strut">&nbsp;</span></p>
<p id="t165" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t166" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t167" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 593::</span><span class="strut">&nbsp;</span></p>
<p id="t168" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t169" class="pln"><span class="str">    sage: str(three_times_four)</span><span class="strut">&nbsp;</span></p>
<p id="t170" class="pln"><span class="str">    '[0, 0, 1, 1]'</span><span class="strut">&nbsp;</span></p>
<p id="t171" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t172" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t173" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 602::</span><span class="strut">&nbsp;</span></p>
<p id="t174" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t175" class="pln"><span class="str">    sage: Id = Transducer([(0, 0, 0, 0), (0, 0, 1, 1)],</span><span class="strut">&nbsp;</span></p>
<p id="t176" class="pln"><span class="str">    ....:                 initial_states=[0], final_states=[0],</span><span class="strut">&nbsp;</span></p>
<p id="t177" class="pln"><span class="str">    ....:                 input_alphabet=[0, 1])</span><span class="strut">&nbsp;</span></p>
<p id="t178" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t179" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t180" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 608::</span><span class="strut">&nbsp;</span></p>
<p id="t181" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t182" class="pln"><span class="str">    sage: prebuiltId = transducers.Identity([0, 1])</span><span class="strut">&nbsp;</span></p>
<p id="t183" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t184" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t185" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 620::</span><span class="strut">&nbsp;</span></p>
<p id="t186" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t187" class="pln"><span class="str">    sage: sage.combinat.finite_state_machine.\</span><span class="strut">&nbsp;</span></p>
<p id="t188" class="pln"><span class="str">    ....:     FSMOldCodeTransducerCartesianProduct = False</span><span class="strut">&nbsp;</span></p>
<p id="t189" class="pln"><span class="str">    sage: Combined_3n_n = Triple.cartesian_product(Id).relabeled()</span><span class="strut">&nbsp;</span></p>
<p id="t190" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t191" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t192" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 630::</span><span class="strut">&nbsp;</span></p>
<p id="t193" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t194" class="pln"><span class="str">    sage: twelve_and_four = Combined_3n_n(4.digits(base=2))</span><span class="strut">&nbsp;</span></p>
<p id="t195" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t196" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t197" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 631::</span><span class="strut">&nbsp;</span></p>
<p id="t198" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t199" class="pln"><span class="str">    sage: str(twelve_and_four)</span><span class="strut">&nbsp;</span></p>
<p id="t200" class="pln"><span class="str">    '[(0, 0), (0, 0), (1, 1), (1, None)]'</span><span class="strut">&nbsp;</span></p>
<p id="t201" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t202" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t203" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 639::</span><span class="strut">&nbsp;</span></p>
<p id="t204" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t205" class="pln"><span class="str">    sage: def g(read0, read1):</span><span class="strut">&nbsp;</span></p>
<p id="t206" class="pln"><span class="str">    ....:     return ZZ(read0) - ZZ(read1)</span><span class="strut">&nbsp;</span></p>
<p id="t207" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t208" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t209" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 643::</span><span class="strut">&nbsp;</span></p>
<p id="t210" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t211" class="pln"><span class="str">    sage: Minus = transducers.operator(g, input_alphabet=[None, -1, 0, 1])</span><span class="strut">&nbsp;</span></p>
<p id="t212" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t213" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t214" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 644::</span><span class="strut">&nbsp;</span></p>
<p id="t215" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t216" class="pln"><span class="str">    sage: latex(ZZ(None))</span><span class="strut">&nbsp;</span></p>
...
<p id="t220" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 650::</span><span class="strut">&nbsp;</span></p>
<p id="t221" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t222" class="pln"><span class="str">    sage: prebuiltMinus = transducers.sub([-1, 0, 1])</span><span class="strut">&nbsp;</span></p>
<p id="t223" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t224" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t225" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 654::</span><span class="strut">&nbsp;</span></p>
<p id="t226" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t227" class="pln"><span class="str">    sage: latex(Combined_3n_n.state(1))</span><span class="strut">&nbsp;</span></p>
...
<p id="t231" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 657::</span><span class="strut">&nbsp;</span></p>
<p id="t232" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t233" class="pln"><span class="str">    sage: final_word_out = Combined_3n_n.state(1).final_word_out</span><span class="strut">&nbsp;</span></p>
<p id="t234" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t235" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t236" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 658::</span><span class="strut">&nbsp;</span></p>
<p id="t237" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t238" class="pln"><span class="str">    sage: str(final_word_out)</span><span class="strut">&nbsp;</span></p>
<p id="t239" class="pln"><span class="str">    '[(1, None)]'</span><span class="strut">&nbsp;</span></p>
<p id="t240" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t241" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t242" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 663::</span><span class="strut">&nbsp;</span></p>
<p id="t243" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t244" class="pln"><span class="str">    sage: NAF3 = Minus(Combined_3n_n).relabeled()</span><span class="strut">&nbsp;</span></p>
<p id="t245" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t246" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t247" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 672::</span><span class="strut">&nbsp;</span></p>
<p id="t248" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t249" class="pln"><span class="str">    sage: NAF_of_12 = NAF3(12.digits(base=2))</span><span class="strut">&nbsp;</span></p>
<p id="t250" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t251" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t252" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 673::</span><span class="strut">&nbsp;</span></p>
<p id="t253" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t254" class="pln"><span class="str">    sage: str(NAF_of_12)</span><span class="strut">&nbsp;</span></p>
<p id="t255" class="pln"><span class="str">    '[0, 0, 0, -1, 0, 1]'</span><span class="strut">&nbsp;</span></p>
<p id="t256" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t257" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t258" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 736::</span><span class="strut">&nbsp;</span></p>
<p id="t259" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t260" class="pln"><span class="str">    sage: NAF = NAF3</span><span class="strut">&nbsp;</span></p>
<p id="t261" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t262" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t263" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 741::</span><span class="strut">&nbsp;</span></p>
<p id="t264" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t265" class="pln"><span class="str">    sage: NAF3n = NAF(Triple)</span><span class="strut">&nbsp;</span></p>
<p id="t266" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t267" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t268" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 749::</span><span class="strut">&nbsp;</span></p>
<p id="t269" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t270" class="pln"><span class="str">    sage: Combined_NAF_3n_n = NAF3n.cartesian_product(NAF).relabeled()</span><span class="strut">&nbsp;</span></p>
<p id="t271" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t272" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t273" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 757::</span><span class="strut">&nbsp;</span></p>
<p id="t274" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t275" class="pln"><span class="str">    sage: T = Minus(Combined_NAF_3n_n).relabeled()</span><span class="strut">&nbsp;</span></p>
<p id="t276" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t277" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t278" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 762::</span><span class="strut">&nbsp;</span></p>
<p id="t279" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t280" class="pln"><span class="str">    sage: str(T)</span><span class="strut">&nbsp;</span></p>
<p id="t281" class="pln"><span class="str">    'Transducer with 9 states'</span><span class="strut">&nbsp;</span></p>
<p id="t282" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t283" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t284" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 769::</span><span class="strut">&nbsp;</span></p>
<p id="t285" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t286" class="pln"><span class="str">    sage: expansion_of_12 = T(12.digits(base=2))</span><span class="strut">&nbsp;</span></p>
<p id="t287" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t288" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t289" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 772::</span><span class="strut">&nbsp;</span></p>
<p id="t290" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t291" class="pln"><span class="str">    sage: str(expansion_of_12)</span><span class="strut">&nbsp;</span></p>
<p id="t292" class="pln"><span class="str">    '[0, 0, 0, 2, 0, -1, 1]'</span><span class="strut">&nbsp;</span></p>
<p id="t293" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t294" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t295" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 806::</span><span class="strut">&nbsp;</span></p>
<p id="t296" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t297" class="pln"><span class="str">    sage: def minus(trans1, trans2):</span><span class="strut">&nbsp;</span></p>
<p id="t298" class="pln"><span class="str">    ....:     if trans1.word_in == trans2.word_in:</span><span class="strut">&nbsp;</span></p>
<p id="t299" class="pln"><span class="str">    ....:         return (trans1.word_in,</span><span class="strut">&nbsp;</span></p>
<p id="t300" class="pln"><span class="str">    ....:                 trans1.word_out[0] - trans2.word_out[0])</span><span class="strut">&nbsp;</span></p>
<p id="t301" class="pln"><span class="str">    ....:     else:</span><span class="strut">&nbsp;</span></p>
<p id="t302" class="pln"><span class="str">    ....:         raise LookupError</span><span class="strut">&nbsp;</span></p>
<p id="t303" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t304" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t305" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 815::</span><span class="strut">&nbsp;</span></p>
<p id="t306" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t307" class="pln"><span class="str">    sage: from six.moves import zip_longest</span><span class="strut">&nbsp;</span></p>
<p id="t308" class="pln"><span class="str">    sage: def final_minus(state1, state2):</span><span class="strut">&nbsp;</span></p>
<p id="t309" class="pln"><span class="str">    ....:     return [x - y for x, y in</span><span class="strut">&nbsp;</span></p>
<p id="t310" class="pln"><span class="str">    ....:         zip_longest(state1.final_word_out,</span><span class="strut">&nbsp;</span></p>
<p id="t311" class="pln"><span class="str">    ....:                     state2.final_word_out,</span><span class="strut">&nbsp;</span></p>
<p id="t312" class="pln"><span class="str">    ....:                     fillvalue=0)]</span><span class="strut">&nbsp;</span></p>
<p id="t313" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t314" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t315" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 829::</span><span class="strut">&nbsp;</span></p>
<p id="t316" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t317" class="pln"><span class="str">    sage: Talternative = NAF3n.product_FiniteStateMachine(</span><span class="strut">&nbsp;</span></p>
<p id="t318" class="pln"><span class="str">    ....:                            NAF, minus,</span><span class="strut">&nbsp;</span></p>
<p id="t319" class="pln"><span class="str">    ....:                            final_function=final_minus).relabeled()</span><span class="strut">&nbsp;</span></p>
<p id="t320" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t321" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t322" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 845::</span><span class="strut">&nbsp;</span></p>
<p id="t323" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t324" class="pln"><span class="str">    sage: Talternative == T</span><span class="strut">&nbsp;</span></p>
...
<p id="t328" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 846::</span><span class="strut">&nbsp;</span></p>
<p id="t329" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t330" class="pln"><span class="str">    sage: str(Talternative==T)</span><span class="strut">&nbsp;</span></p>
...
<p id="t334" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 854::</span><span class="strut">&nbsp;</span></p>
<p id="t335" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t336" class="pln"><span class="str">    sage: for t in T.iter_states():</span><span class="strut">&nbsp;</span></p>
<p id="t337" class="pln"><span class="str">    ....:     other = Talternative.state(t.label())</span><span class="strut">&nbsp;</span></p>
<p id="t338" class="pln"><span class="str">    ....:     assert t.is_final == other.is_final</span><span class="strut">&nbsp;</span></p>
<p id="t339" class="pln"><span class="str">    ....:     if t.is_final:</span><span class="strut">&nbsp;</span></p>
<p id="t340" class="pln"><span class="str">    ....:         assert t.final_word_out == other.final_word_out</span><span class="strut">&nbsp;</span></p>
<p id="t341" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t342" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t343" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 872::</span><span class="strut">&nbsp;</span></p>
<p id="t344" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t345" class="pln"><span class="str">    sage: sage.combinat.finite_state_machine.setup_latex_preamble()</span><span class="strut">&nbsp;</span></p>
<p id="t346" class="pln"><span class="str">    sage: latex.mathjax_avoid_list('tikzpicture')</span><span class="strut">&nbsp;</span></p>
<p id="t347" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t348" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t349" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 888::</span><span class="strut">&nbsp;</span></p>
<p id="t350" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t351" class="pln"><span class="str">    sage: T.set_coordinates({</span><span class="strut">&nbsp;</span></p>
<p id="t352" class="pln"><span class="str">    ....:     0: (-2, 0.75),</span><span class="strut">&nbsp;</span></p>
<p id="t353" class="pln"><span class="str">    ....:     1: (0, -1),</span><span class="strut">&nbsp;</span></p>
<p id="t354" class="pln"><span class="str">    ....:     2: (-6, -1),</span><span class="strut">&nbsp;</span></p>
<p id="t355" class="pln"><span class="str">    ....:     3: (6, -1),</span><span class="strut">&nbsp;</span></p>
<p id="t356" class="pln"><span class="str">    ....:     4: (-4, 2.5),</span><span class="strut">&nbsp;</span></p>
<p id="t357" class="pln"><span class="str">    ....:     5: (-6, 5),</span><span class="strut">&nbsp;</span></p>
<p id="t358" class="pln"><span class="str">    ....:     6: (6, 5),</span><span class="strut">&nbsp;</span></p>
<p id="t359" class="pln"><span class="str">    ....:     7: (4, 2.5),</span><span class="strut">&nbsp;</span></p>
<p id="t360" class="pln"><span class="str">    ....:     8: (2, 0.75)})</span><span class="strut">&nbsp;</span></p>
<p id="t361" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t362" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t363" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 905::</span><span class="strut">&nbsp;</span></p>
<p id="t364" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t365" class="pln"><span class="str">    sage: T.latex_options(format_letter=T.format_letter_negative,</span><span class="strut">&nbsp;</span></p>
<p id="t366" class="pln"><span class="str">    ....:                 accepting_where={</span><span class="strut">&nbsp;</span></p>
<p id="t367" class="pln"><span class="str">    ....:                   0: 'right',</span><span class="strut">&nbsp;</span></p>
<p id="t368" class="pln"><span class="str">    ....:                   1: 'below',</span><span class="strut">&nbsp;</span></p>
<p id="t369" class="pln"><span class="str">    ....:                   2: 'below',</span><span class="strut">&nbsp;</span></p>
<p id="t370" class="pln"><span class="str">    ....:                   3: 'below',</span><span class="strut">&nbsp;</span></p>
<p id="t371" class="pln"><span class="str">    ....:                   4: 60,</span><span class="strut">&nbsp;</span></p>
<p id="t372" class="pln"><span class="str">    ....:                   5: 'above',</span><span class="strut">&nbsp;</span></p>
<p id="t373" class="pln"><span class="str">    ....:                   6: 'above',</span><span class="strut">&nbsp;</span></p>
<p id="t374" class="pln"><span class="str">    ....:                   7: 120,</span><span class="strut">&nbsp;</span></p>
<p id="t375" class="pln"><span class="str">    ....:                   8: 'left'},</span><span class="strut">&nbsp;</span></p>
<p id="t376" class="pln"><span class="str">    ....:                 accepting_show_empty=True)</span><span class="strut">&nbsp;</span></p>
<p id="t377" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t378" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t379" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 919::</span><span class="strut">&nbsp;</span></p>
<p id="t380" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t381" class="pln"><span class="str">    sage: str(latex(T))</span><span class="strut">&nbsp;</span></p>
<p id="t382" class="pln"><span class="str">    '\\begin{tikzpicture}[auto, initial text=, >=latex, accepting text=, accepting/.style=accepting by arrow, accepting distance=7ex]\n\\node[state, initial] (v0) at (-2.000000, 0.750000) {$0$};\n\\path[->] (v0.0.00) edge node[rotate=0.00, anchor=south] {$\\$ \\mid \\varepsilon$} ++(0.00:7ex);\n\\node[state] (v1) at (0.000000, -1.000000) {$1$};\n\\path[->] (v1.270.00) edge node[rotate=450.00, anchor=south] {$\\$ \\mid \\overline{2} 0 1$} ++(270.00:7ex);\n\\node[state] (v2) at (-6.000000, -1.000000) {$2$};\n\\path[->] (v2.270.00) edge node[rotate=450.00, anchor=south] {$\\$ \\mid 0 1$} ++(270.00:7ex);\n\\node[state] (v3) at (6.000000, -1.000000) {$3$};\n\\path[->] (v3.270.00) edge node[rotate=450.00, anchor=south] {$\\$ \\mid 0 \\overline{1} 1$} ++(270.00:7ex);\n\\node[state] (v4) at (-4.000000, 2.500000) {$4$};\n\\path[->] (v4.60.00) edge node[rotate=60.00, anchor=south] {$\\$ \\mid 1$} ++(60.00:7ex);\n\\node[state] (v5) at (-6.000000, 5.000000) {$5$};\n\\path[->] (v5.90.00) edge node[rotate=90.00, anchor=south] {$\\$ \\mid \\overline{1} 0 1$} ++(90.00:7ex);\n\\node[state] (v6) at (6.000000, 5.000000) {$6$};\n\\path[->] (v6.90.00) edge node[rotate=90.00, anchor=south] {$\\$ \\mid \\overline{1} 1$} ++(90.00:7ex);\n\\node[state] (v7) at (4.000000, 2.500000) {$7$};\n\\path[->] (v7.120.00) edge node[rotate=300.00, anchor=south] {$\\$ \\mid 1 \\overline{1} 1$} ++(120.00:7ex);\n\\node[state] (v8) at (2.000000, 0.750000) {$8$};\n\\path[->] (v8.180.00) edge node[rotate=360.00, anchor=south] {$\\$ \\mid 0 \\overline{2} 0 1$} ++(180.00:7ex);\n\\path[->] (v0) edge[loop above] node {$0\\mid 0$} ();\n\\path[->] (v0) edge node[rotate=-41.19, anchor=south] {$1\\mid 0$} (v1);\n\\path[->] (v1) edge node[rotate=360.00, anchor=south] {$0\\mid \\overline{2}$} (v2);\n\\path[->] (v1) edge node[rotate=0.00, anchor=south] {$1\\mid 2$} (v3);\n\\path[->] (v2) edge node[rotate=60.26, anchor=south] {$0\\mid 0$} (v4);\n\\path[->] (v2.95.00) edge node[rotate=90.00, anchor=south] {$1\\mid 0$} (v5.265.00);\n\\path[->] (v3.95.00) edge node[rotate=90.00, anchor=south] {$0\\mid 0$} (v6.265.00);\n\\path[->] (v3) edge node[rotate=299.74, anchor=south] {$1\\mid 0$} (v7);\n\\path[->] (v4) edge node[rotate=-41.19, anchor=south] {$0\\mid 1$} (v0);\n\\path[->] (v4) edge node[rotate=308.66, anchor=south] {$1\\mid \\overline{1}$} (v5);\n\\path[->] (v5.-85.00) edge node[rotate=90.00, anchor=north] {$0\\mid \\overline{1}$} (v2.85.00);\n\\path[->] (v5) edge node[rotate=-14.04, anchor=south] {$1\\mid 1$} (v7);\n\\path[->] (v6.-85.00) edge node[rotate=90.00, anchor=north] {$1\\mid 1$} (v3.85.00);\n\\path[->] (v6) edge node[rotate=14.04, anchor=south] {$0\\mid \\overline{1}$} (v4);\n\\path[->] (v7) edge node[rotate=51.34, anchor=south] {$0\\mid 1$} (v6);\n\\path[->] (v7) edge node[rotate=41.19, anchor=south] {$1\\mid \\overline{1}$} (v8);\n\\path[->] (v8) edge node[rotate=41.19, anchor=south] {$0\\mid 0$} (v1);\n\\path[->] (v8) edge[loop above] node {$1\\mid 0$} ();\n\\end{tikzpicture}'</span><span class="strut">&nbsp;</span></p>
<p id="t383" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t384" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t385" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 946::</span><span class="strut">&nbsp;</span></p>
<p id="t386" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t387" class="pln"><span class="str">    sage: R = T.output_projection()</span><span class="strut">&nbsp;</span></p>
<p id="t388" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t389" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t390" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 951::</span><span class="strut">&nbsp;</span></p>
<p id="t391" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t392" class="pln"><span class="str">    sage: latex(len(R.states()))</span><span class="strut">&nbsp;</span></p>
<p id="t393" class="pln"><span class="str">    10</span><span class="strut">&nbsp;</span></p>
<p id="t394" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t395" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t396" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 955::</span><span class="strut">&nbsp;</span></p>
<p id="t397" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t398" class="pln"><span class="str">    sage: R = R.split_transitions()</span><span class="strut">&nbsp;</span></p>
<p id="t399" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t400" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t401" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 956::</span><span class="strut">&nbsp;</span></p>
<p id="t402" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t403" class="pln"><span class="str">    sage: latex(len(R.states()))</span><span class="strut">&nbsp;</span></p>
<p id="t404" class="pln"><span class="str">    23</span><span class="strut">&nbsp;</span></p>
<p id="t405" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t406" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t407" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 959::</span><span class="strut">&nbsp;</span></p>
<p id="t408" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t409" class="pln"><span class="str">    sage: str(R.is_deterministic())</span><span class="strut">&nbsp;</span></p>
...
<p id="t413" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 964::</span><span class="strut">&nbsp;</span></p>
<p id="t414" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t415" class="pln"><span class="str">    sage: Rdet = R.determinisation()</span><span class="strut">&nbsp;</span></p>
<p id="t416" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t417" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t418" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 967::</span><span class="strut">&nbsp;</span></p>
<p id="t419" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t420" class="pln"><span class="str">    sage: latex(len(Rdet.states()))</span><span class="strut">&nbsp;</span></p>
<p id="t421" class="pln"><span class="str">    22</span><span class="strut">&nbsp;</span></p>
<p id="t422" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t423" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t424" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 974::</span><span class="strut">&nbsp;</span></p>
<p id="t425" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t426" class="pln"><span class="str">    sage: Rdet12 = Rdet(expansion_of_12)</span><span class="strut">&nbsp;</span></p>
<p id="t427" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t428" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t429" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 977::</span><span class="strut">&nbsp;</span></p>
<p id="t430" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t431" class="pln"><span class="str">    sage: str(Rdet12)</span><span class="strut">&nbsp;</span></p>
...
<p id="t435" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 984::</span><span class="strut">&nbsp;</span></p>
<p id="t436" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t437" class="pln"><span class="str">    sage: Rdet1 = Rdet.minimization()</span><span class="strut">&nbsp;</span></p>
<p id="t438" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t439" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t440" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 986::</span><span class="strut">&nbsp;</span></p>
<p id="t441" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t442" class="pln"><span class="str">    sage: latex(len(Rdet1.states()))</span><span class="strut">&nbsp;</span></p>
<p id="t443" class="pln"><span class="str">    17</span><span class="strut">&nbsp;</span></p>
<p id="t444" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t445" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t446" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 999::</span><span class="strut">&nbsp;</span></p>
<p id="t447" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t448" class="pln"><span class="str">    sage: Rdet2 = R.minimization(algorithm='Brzozowski')</span><span class="strut">&nbsp;</span></p>
<p id="t449" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t450" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t451" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1001::</span><span class="strut">&nbsp;</span></p>
<p id="t452" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t453" class="pln"><span class="str">    sage: latex(len(Rdet2.states()))</span><span class="strut">&nbsp;</span></p>
<p id="t454" class="pln"><span class="str">    17</span><span class="strut">&nbsp;</span></p>
<p id="t455" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t456" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t457" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1034::</span><span class="strut">&nbsp;</span></p>
<p id="t458" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t459" class="pln"><span class="str">    sage: def weight(state_from, read):</span><span class="strut">&nbsp;</span></p>
<p id="t460" class="pln"><span class="str">    ....:     write = ZZ(read != 0)</span><span class="strut">&nbsp;</span></p>
<p id="t461" class="pln"><span class="str">    ....:     return (0, write)</span><span class="strut">&nbsp;</span></p>
<p id="t462" class="pln"><span class="str">    sage: Weight = Transducer(weight, input_alphabet=srange(-2, 2+1),</span><span class="strut">&nbsp;</span></p>
<p id="t463" class="pln"><span class="str">    ....:                     initial_states=[0], final_states=[0])</span><span class="strut">&nbsp;</span></p>
<p id="t464" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t465" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t466" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1044::</span><span class="strut">&nbsp;</span></p>
<p id="t467" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t468" class="pln"><span class="str">    sage: prebuiltWeight = transducers.weight(srange(-2, 2+1))</span><span class="strut">&nbsp;</span></p>
<p id="t469" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t470" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t471" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1050::</span><span class="strut">&nbsp;</span></p>
<p id="t472" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t473" class="pln"><span class="str">    sage: W = Weight(T)</span><span class="strut">&nbsp;</span></p>
<p id="t474" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t475" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t476" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1051::</span><span class="strut">&nbsp;</span></p>
<p id="t477" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t478" class="pln"><span class="str">    sage: latex(len(W.states()))</span><span class="strut">&nbsp;</span></p>
...
<p id="t482" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1056::</span><span class="strut">&nbsp;</span></p>
<p id="t483" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t484" class="pln"><span class="str">    sage: W(12.digits(base=2))</span><span class="strut">&nbsp;</span></p>
<p id="t485" class="pln"><span class="str">    [0, 0, 0, 1, 0, 1, 1]</span><span class="strut">&nbsp;</span></p>
<p id="t486" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t487" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t488" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1057::</span><span class="strut">&nbsp;</span></p>
<p id="t489" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t490" class="pln"><span class="str">    sage: str(W(12.digits(base=2)))</span><span class="strut">&nbsp;</span></p>
<p id="t491" class="pln"><span class="str">    '[0, 0, 0, 1, 0, 1, 1]'</span><span class="strut">&nbsp;</span></p>
<p id="t492" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t493" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t494" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1058::</span><span class="strut">&nbsp;</span></p>
<p id="t495" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t496" class="pln"><span class="str">    sage: latex(add(W(12.digits(base=2))))</span><span class="strut">&nbsp;</span></p>
...
<p id="t500" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1064::</span><span class="strut">&nbsp;</span></p>
<p id="t501" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t502" class="pln"><span class="str">    sage: W.prepone_output()</span><span class="strut">&nbsp;</span></p>
<p id="t503" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t504" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t505" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1091::</span><span class="strut">&nbsp;</span></p>
<p id="t506" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t507" class="pln"><span class="str">    sage: var('y')</span><span class="strut">&nbsp;</span></p>
<p id="t508" class="pln"><span class="str">    y</span><span class="strut">&nbsp;</span></p>
<p id="t509" class="pln"><span class="str">    sage: def am_entry(trans):</span><span class="strut">&nbsp;</span></p>
<p id="t510" class="pln"><span class="str">    ....:     return y^add(trans.word_out) / 2</span><span class="strut">&nbsp;</span></p>
<p id="t511" class="pln"><span class="str">    sage: A = W.adjacency_matrix(entry=am_entry)</span><span class="strut">&nbsp;</span></p>
<p id="t512" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t513" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t514" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1097::</span><span class="strut">&nbsp;</span></p>
<p id="t515" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t516" class="pln"><span class="str">    sage: latex.matrix_column_alignment('c')</span><span class="strut">&nbsp;</span></p>
<p id="t517" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t518" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t519" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1099::</span><span class="strut">&nbsp;</span></p>
<p id="t520" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t521" class="pln"><span class="str">    sage: latex(A)</span><span class="strut">&nbsp;</span></p>
<p id="t522" class="pln"><span class="str">    \left(\begin{array}{ccccccccc}</span><span class="strut">&nbsp;</span></p>
<p id="t523" class="pln"><span class="str">    \frac{1}{2} &amp; \frac{1}{2} \, y^{2} &amp; 0 &amp; 0 &amp; 0 &amp; 0 &amp; 0 &amp; 0 &amp; 0 \\</span><span class="strut">&nbsp;</span></p>
<p id="t524" class="pln"><span class="str">    0 &amp; 0 &amp; \frac{1}{2} &amp; \frac{1}{2} &amp; 0 &amp; 0 &amp; 0 &amp; 0 &amp; 0 \\</span><span class="strut">&nbsp;</span></p>
<p id="t525" class="pln"><span class="str">    0 &amp; 0 &amp; 0 &amp; 0 &amp; \frac{1}{2} &amp; \frac{1}{2} &amp; 0 &amp; 0 &amp; 0 \\</span><span class="strut">&nbsp;</span></p>
<p id="t526" class="pln"><span class="str">    0 &amp; 0 &amp; 0 &amp; 0 &amp; 0 &amp; 0 &amp; \frac{1}{2} &amp; \frac{1}{2} &amp; 0 \\</span><span class="strut">&nbsp;</span></p>
<p id="t527" class="pln"><span class="str">    \frac{1}{2} &amp; 0 &amp; 0 &amp; 0 &amp; 0 &amp; \frac{1}{2} \, y &amp; 0 &amp; 0 &amp; 0 \\</span><span class="strut">&nbsp;</span></p>
<p id="t528" class="pln"><span class="str">    0 &amp; 0 &amp; \frac{1}{2} \, y &amp; 0 &amp; 0 &amp; 0 &amp; 0 &amp; \frac{1}{2} \, y &amp; 0 \\</span><span class="strut">&nbsp;</span></p>
<p id="t529" class="pln"><span class="str">    0 &amp; 0 &amp; 0 &amp; \frac{1}{2} \, y &amp; \frac{1}{2} \, y &amp; 0 &amp; 0 &amp; 0 &amp; 0 \\</span><span class="strut">&nbsp;</span></p>
<p id="t530" class="pln"><span class="str">    0 &amp; 0 &amp; 0 &amp; 0 &amp; 0 &amp; 0 &amp; \frac{1}{2} \, y &amp; 0 &amp; \frac{1}{2} \\</span><span class="strut">&nbsp;</span></p>
<p id="t531" class="pln"><span class="str">    0 &amp; \frac{1}{2} \, y^{2} &amp; 0 &amp; 0 &amp; 0 &amp; 0 &amp; 0 &amp; 0 &amp; \frac{1}{2}</span><span class="strut">&nbsp;</span></p>
<p id="t532" class="pln"><span class="str">    \end{array}\right)</span><span class="strut">&nbsp;</span></p>
<p id="t533" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t534" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t535" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1109::</span><span class="strut">&nbsp;</span></p>
<p id="t536" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t537" class="pln"><span class="str">    sage: (pi_not_normalized,) = (A.subs(y=1) - A.parent().identity_matrix())\</span><span class="strut">&nbsp;</span></p>
<p id="t538" class="pln"><span class="str">    ....:                            .left_kernel().basis()</span><span class="strut">&nbsp;</span></p>
<p id="t539" class="pln"><span class="str">    sage: pi = pi_not_normalized / pi_not_normalized.norm(p=1)</span><span class="strut">&nbsp;</span></p>
<p id="t540" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t541" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t542" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1110::</span><span class="strut">&nbsp;</span></p>
<p id="t543" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t544" class="pln"><span class="str">    sage: str(pi)</span><span class="strut">&nbsp;</span></p>
<p id="t545" class="pln"><span class="str">    '(1/9, 1/9, 1/9, 1/9, 1/9, 1/9, 1/9, 1/9, 1/9)'</span><span class="strut">&nbsp;</span></p>
<p id="t546" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t547" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t548" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1117::</span><span class="strut">&nbsp;</span></p>
<p id="t549" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t550" class="pln"><span class="str">    sage: expected_output = derivative(A, y).subs(y=1) * vector(len(W.states())*[1])</span><span class="strut">&nbsp;</span></p>
<p id="t551" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t552" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t553" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1118::</span><span class="strut">&nbsp;</span></p>
<p id="t554" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t555" class="pln"><span class="str">    sage: latex(expected_output)</span><span class="strut">&nbsp;</span></p>
<p id="t556" class="pln"><span class="str">    \left(1,\,0,\,0,\,0,\,\frac{1}{2},\,1,\,1,\,\frac{1}{2},\,1\right)</span><span class="strut">&nbsp;</span></p>
<p id="t557" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t558" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t559" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1126::</span><span class="strut">&nbsp;</span></p>
<p id="t560" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t561" class="pln"><span class="str">    sage: pi * expected_output</span><span class="strut">&nbsp;</span></p>
<p id="t562" class="pln"><span class="str">    5/9</span><span class="strut">&nbsp;</span></p>
<p id="t563" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t564" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t565" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1127::</span><span class="strut">&nbsp;</span></p>
<p id="t566" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t567" class="pln"><span class="str">    sage: latex(pi * expected_output)</span><span class="strut">&nbsp;</span></p>
<p id="t568" class="pln"><span class="str">    \frac{5}{9}</span><span class="strut">&nbsp;</span></p>
<p id="t569" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t570" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t571" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1129::</span><span class="strut">&nbsp;</span></p>
<p id="t572" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t573" class="pln"><span class="str">    sage: latex(pi * expected_output)</span><span class="strut">&nbsp;</span></p>
<p id="t574" class="pln"><span class="str">    \frac{5}{9}</span><span class="strut">&nbsp;</span></p>
<p id="t575" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t576" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t577" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1145::</span><span class="strut">&nbsp;</span></p>
<p id="t578" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t579" class="pln"><span class="str">    sage: var('k')</span><span class="strut">&nbsp;</span></p>
<p id="t580" class="pln"><span class="str">    k</span><span class="strut">&nbsp;</span></p>
<p id="t581" class="pln"><span class="str">    sage: moments = W.asymptotic_moments(k)</span><span class="strut">&nbsp;</span></p>
<p id="t582" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t583" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t584" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1155::</span><span class="strut">&nbsp;</span></p>
<p id="t585" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t586" class="pln"><span class="str">    sage: latex(moments['expectation'])</span><span class="strut">&nbsp;</span></p>
<p id="t587" class="pln"><span class="str">    \frac{5}{9} \, k + \mathcal{O}\left(1\right)</span><span class="strut">&nbsp;</span></p>
<p id="t588" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t589" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t590" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1162::</span><span class="strut">&nbsp;</span></p>
<p id="t591" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t592" class="pln"><span class="str">    sage: latex(moments['variance'])</span><span class="strut">&nbsp;</span></p>
<p id="t593" class="pln"><span class="str">    \frac{44}{243} \, k + \mathcal{O}\left(1\right)</span><span class="strut">&nbsp;</span></p>
<p id="t594" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t595" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t596" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1192::</span><span class="strut">&nbsp;</span></p>
<p id="t597" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t598" class="pln"><span class="str">    sage: expectation_binary = Id.asymptotic_moments(k)['expectation']</span><span class="strut">&nbsp;</span></p>
<p id="t599" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t600" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t601" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1195::</span><span class="strut">&nbsp;</span></p>
<p id="t602" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t603" class="pln"><span class="str">    sage: latex(expectation_binary)</span><span class="strut">&nbsp;</span></p>
<p id="t604" class="pln"><span class="str">    \frac{1}{2} \, k + \mathcal{O}\left(1\right)</span><span class="strut">&nbsp;</span></p>
<p id="t605" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t606" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t607" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1202::</span><span class="strut">&nbsp;</span></p>
<p id="t608" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t609" class="pln"><span class="str">    sage: expectation_NAF = Weight(NAF).asymptotic_moments(k)['expectation']</span><span class="strut">&nbsp;</span></p>
<p id="t610" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t611" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t612" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1205::</span><span class="strut">&nbsp;</span></p>
<p id="t613" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t614" class="pln"><span class="str">    sage: latex(expectation_NAF)</span><span class="strut">&nbsp;</span></p>
<p id="t615" class="pln"><span class="str">    \frac{1}{3} \, k + \mathcal{O}\left(1\right)</span><span class="strut">&nbsp;</span></p>
<p id="t616" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t617" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t618" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1211::</span><span class="strut">&nbsp;</span></p>
<p id="t619" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t620" class="pln"><span class="str">    sage: Abs = transducers.abs([-1, 0, 1])</span><span class="strut">&nbsp;</span></p>
<p id="t621" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t622" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t623" class="pln"><span class="str">Sage example in fsm-in-sage.tex, line 1216::</span><span class="strut">&nbsp;</span></p>
<p id="t624" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t625" class="pln"><span class="str">    sage: latex(moments['expectation'])</span><span class="strut">&nbsp;</span></p>
<p id="t626" class="pln"><span class="str">    \frac{5}{9} \, k + \mathcal{O}\left(1\right)</span><span class="strut">&nbsp;</span></p>
