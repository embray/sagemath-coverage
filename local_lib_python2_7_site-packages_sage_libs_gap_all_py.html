...
<head>
    ...
    <title>Coverage for local/lib/python2.7/site-packages/sage/libs/gap/all.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>local/lib/python2.7/site-packages/sage/libs/gap/all.py</b> :
